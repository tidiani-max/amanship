...
const allOrders = ordersResponse?.orders || []; 
 ...
 const activeOrders = allOrders.filter((o: any) => 
  ["pending", "picking", "packing", "packed", "delivering", "arrived", "created", "confirmed"].includes(o.status?.toLowerCase())
);
  ...
  const getStatusTheme = (status: string) => {
    ...
    switch (s) {
      ...
      case "arrived": return { color: "#f59e0b", icon: "map-pin", label: "DRIVER ARRIVED", progress: 0.98 };
