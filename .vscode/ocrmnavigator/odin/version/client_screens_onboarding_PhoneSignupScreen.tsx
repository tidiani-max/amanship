      ...
      <View style={styles.centerWrapper}>
        <View style={styles.content}>
          ...
          <ThemedText type="h2" style={styles.title}>
            ...
            {step === "otp" && (mode === "forgot" ? "New Password" : "Check Your WhatsApp")}
          </ThemedText>

          {step === "otp" && (
  <View style={[styles.codeHint, { backgroundColor: QIKLY_LIGHT_BLUE }]}>
    <Feather name="message-circle" size={16} color={QIKLY_BLUE} />
    <ThemedText type="caption" style={{ color: QIKLY_BLUE, fontWeight: '700', marginTop: 4 }}>
      We sent a 6-digit code to your WhatsApp {"\n"}{fullPhone}
    </ThemedText>
    {sentCode && (
      // Only shows in dev mode when FONNTE_API_KEY is not set
      <ThemedText type="caption" style={{ color: QIKLY_BLUE, marginTop: 4 }}>
        Dev code: {sentCode}
      </ThemedText>
    )}
  </View>
