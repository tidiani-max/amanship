  ...
  <View style={styles.contentSection}>
    ...
    <View style={styles.statsGrid}>
      ...
      <View style={[styles.statCard, { backgroundColor: theme.error + '10', borderColor: theme.error + '30' }]}>
        <ThemedText style={[styles.statLabel, { color: theme.error }]}>TOTAL COSTS</ThemedText>
        <ThemedText style={[styles.statValue, { color: theme.error }]}>
          {formatCurrency(financialMetrics?.totalCosts || 0)}
        </ThemedText>
        <ThemedText style={[styles.statSubtext, { color: theme.textSecondary }]}>
      ...
      <View style={[styles.statCard, { 
        backgroundColor: (financialMetrics?.netProfit || 0) >= 0 ? theme.primary + '10' : theme.error + '10',
        borderColor: (financialMetrics?.netProfit || 0) >= 0 ? theme.primary + '30' : theme.error + '30'
      }]}>
        <ThemedText style={[styles.statLabel, { 
          color: (financialMetrics?.netProfit || 0) >= 0 ? theme.primary : theme.error 
        }]}>NET PROFIT</ThemedText>
        ...
        <ThemedText style={[styles.statSubtext, { color: theme.textSecondary }]}>
          {((financialMetrics?.netProfit || 0) / (financialMetrics?.totalRevenue || 1) * 100).toFixed(1)}% margin
        </ThemedText>
      </View>

      {/* Profit Target */}
      <View style={[styles.statCard, { backgroundColor: theme.warning + '10', borderColor: theme.warning + '30' }]}>
        <ThemedText style={[styles.statLabel, { color: theme.warning }]}>MONTHLY TARGET</ThemedText>
        <ThemedText style={[styles.statValue, { color: theme.warning }]}>
          {formatCurrency(financialMetrics?.monthlyTarget || 50000000)}
        </ThemedText>
        <ThemedText style={[styles.statSubtext, { color: theme.textSecondary }]}>
          {((financialMetrics?.netProfit || 0) / (financialMetrics?.monthlyTarget || 50000000) * 100).toFixed(1)}% achieved
        </ThemedText>
      </View>
    </View>

    {/* Revenue Breakdown */}
    <View style={[styles.metricsRow, { marginTop: Spacing.xl, paddingTop: Spacing.xl, borderTopWidth: 1, borderTopColor: theme.border }]}>
      <View style={styles.metricBox}>
        <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>
          Product Revenue
        </ThemedText>
        <ThemedText style={[styles.metricBoxValue, { color: theme.success }]}>
          {formatCurrency(financialMetrics?.productRevenue || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          {((financialMetrics?.productRevenue || 0) / (financialMetrics?.totalRevenue || 1) * 100).toFixed(0)}% of revenue
        </ThemedText>
      </View>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.success }]}>
          {formatCurrency(financialMetrics?.deliveryRevenue || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          {((financialMetrics?.deliveryRevenue || 0) / (financialMetrics?.totalRevenue || 1) * 100).toFixed(0)}% of revenue
        </ThemedText>
      </View>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.error }]}>
          {formatCurrency(financialMetrics?.productCosts || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          Cost of goods sold
        </ThemedText>
    ...
    {/* Expenses Breakdown */}
    <View style={[styles.metricsRow, { marginTop: Spacing.lg, paddingTop: Spacing.lg, borderTopWidth: 1, borderTopColor: theme.border }]}>
      <View style={styles.metricBox}>
        <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>
          Staff Bonuses
        </ThemedText>
        <ThemedText style={[styles.metricBoxValue, { color: theme.warning }]}>
          {formatCurrency(financialMetrics?.staffBonuses || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          Rp 6k per order
        </ThemedText>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.error }]}>
          {formatCurrency(financialMetrics?.adminPromoCosts || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          From admin profit
        </ThemedText>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.warning }]}>
          {formatCurrency(financialMetrics?.storePromoCosts || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          From store profits
        </ThemedText>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.error }]}>
          {formatCurrency(financialMetrics?.voucherCosts || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          System-wide
        </ThemedText>
    ...
    <View style={[styles.metricsRow, { marginTop: Spacing.lg, paddingTop: Spacing.lg, borderTopWidth: 1, borderTopColor: theme.border }]}>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.success }]}>
          {formatCurrency(financialMetrics?.deliveryProfit || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          Rp 12k - Rp 6k bonus
        </ThemedText>
      ...
      <View style={styles.metricBox}>
        ...
        <ThemedText style={[styles.metricBoxValue, { color: theme.primary }]}>
          {formatCurrency(financialMetrics?.avgOrderValue || 0)}
        </ThemedText>
        <ThemedText style={[styles.metricBoxSub, { color: theme.textSecondary }]}>
          Per transaction
        </ThemedText>
    ...
    <View style={{ marginTop: Spacing.xxl }}>
      ...
      {(financialMetrics?.storeBreakdown || []).map((store: any) => (
        <View key={store.storeId} style={[styles.storeCard, { 
          ...
          <View style={styles.storeHeader}>
            <View style={{ flex: 1 }}>
              <ThemedText style={styles.storeName}>{store.storeName}</ThemedText>
              <ThemedText style={[styles.storeAddress, { color: theme.textSecondary }]}>
                {store.totalOrders} orders • Avg: {formatCurrency(store.avgOrderValue)}
              </ThemedText>
            </View>
            <View style={[styles.storeBadge, { 
              backgroundColor: store.netProfit >= 0 ? theme.success + '20' : theme.error + '20' 
            }]}>
              <ThemedText style={{ 
                fontSize: 16, 
                fontWeight: '700', 
                color: store.netProfit >= 0 ? theme.success : theme.error 
              }}>
          ...
          <View style={[styles.metricsRow, { borderBottomWidth: 0 }]}>
            <View style={styles.metricBox}>
              <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>Revenue</ThemedText>
              <ThemedText style={[styles.metricBoxValue, { fontSize: 18, color: theme.success }]}>
                {formatCurrency(store.totalRevenue)}
              </ThemedText>
            </View>

            <View style={styles.metricBox}>
              <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>Product Costs</ThemedText>
              <ThemedText style={[styles.metricBoxValue, { fontSize: 18, color: theme.error }]}>
                {formatCurrency(store.productCosts)}
              </ThemedText>
            </View>

            <View style={styles.metricBox}>
              <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>Store Promos</ThemedText>
              <ThemedText style={[styles.metricBoxValue, { fontSize: 18, color: theme.warning }]}>
                {formatCurrency(store.storePromoCosts)}
              </ThemedText>
            </View>

            <View style={styles.metricBox}>
              <ThemedText style={[styles.metricBoxLabel, { color: theme.textSecondary }]}>Net Profit</ThemedText>
              <ThemedText style={[styles.metricBoxValue, { 
                fontSize: 18, 
                color: store.netProfit >= 0 ? theme.success : theme.error 
              }]}>
          ...
          <View style={{ marginTop: Spacing.md }}>
            <ThemedText style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>
              Profit Margin: {((store.netProfit / store.totalRevenue) * 100).toFixed(1)}%
            </ThemedText>
            <View style={{ 
              height: 8, 
              ...
              <View style={{ 
                height: '100%', 
                width: `${Math.max(0, Math.min(100, (store.netProfit / store.totalRevenue) * 100))}%`,
                backgroundColor: store.netProfit >= 0 ? theme.success : theme.error
              }} />
            </View>
          </View>
        </View>
    ...
    <View style={{ marginTop: Spacing.xxl }}>
      ...
      <View style={[styles.infoBox, { backgroundColor: theme.primary + '10', borderColor: theme.primary + '30', borderWidth: 1, padding: Spacing.lg }]}>
        {(financialMetrics?.recommendations || []).map((rec: string, idx: number) => (
          <View key={idx} style={{ flexDirection: 'row', marginBottom: Spacing.sm }}>
            <ThemedText style={{ color: theme.primary, marginRight: 8 }}>•</ThemedText>
            <ThemedText style={{ flex: 1, color: theme.text }}>{rec}</ThemedText>
          </View>
        ))}
      </View>
    </View>
