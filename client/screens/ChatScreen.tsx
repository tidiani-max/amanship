...
export default function ChatScreen() {
  ...
  const { data: orderDetails } = useQuery({
    ...
    queryFn: async () => {
      const res = await fetch(`https://amanship-production.up.railway.app//api/orders/${orderId}`);
      return res.json();
    },
  });
  ...
  const { data: messages = [] } = useQuery({
    ...
    queryFn: async () => {
      const res = await fetch(`https://amanship-production.up.railway.app//api/orders/${orderId}/messages`);
      return res.json();
    },
  ...
  mutationFn: async ({ content, type = "text" }: { content: string; type?: "text" | "image" }) => {
    ...
    const res = await fetch(`https://amanship-production.up.railway.app//api/messages`, {
      method: "POST",
      body: formData,
